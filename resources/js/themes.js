const themes =  {
    light: {
        ...
        secondaryGradient: 'linear-gradient(30deg, rgba(30,144,255,1) 0%, rgba(30,200,255,1) 100%)',
        text: 'rgb(10,10,10)',
    ...
    dark: {
        ...
        secondaryGradient: 'linear-gradient(30deg, rgba(25,91,219,1) 0%, rgba(25,150,219,1) 100%)',
